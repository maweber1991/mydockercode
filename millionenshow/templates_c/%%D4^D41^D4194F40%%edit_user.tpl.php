<?php /* Smarty version 2.6.26, created on 2015-04-29 16:03:47
         compiled from edit_user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'edit_user.tpl', 69, false),)), $this); ?>
...
">
	<input type="hidden" id="hiddenuserid" name="userid" value="<?php echo $this->_tpl_vars['USERID']; ?>
">
	<table id="editUser" cellspacing="1">
		...
		<tbody>
			...
			<tr> 
				<td>*Username:</td>
				<td><input class="validate[required] text-input"  id="username" type="text" name="username" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['USERNAME'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></td>
			</tr>
			<tr> 
				<td>*Passwort:</td>
			...
			<tr> 
				<td>*Email:</td>
				<td><input type="text" class="validate[required,custom[email]] text-input" id="email" name="email" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['EMAIL'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></td>
			</tr> 
			<tr> 
				<td>Adminstrator</td>
				<td><input type="checkbox" id="is_admin" name="is_admin" <?php if ($this->_tpl_vars['post']['IS_ADMIN'] == 1): ?>checked<?php endif; ?>></td>
			</tr> 
