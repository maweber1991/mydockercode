...
<input type="hidden" id="hiddenfrage_nr" name="frage_nr" value="{$FRAGE_NR}"></input>
<input type="hidden" id="hiddenebene" name="ebene" value="{$EBENE}"></input>
<input type="hidden" id="hiddenjokeranz" name="joker" value="{$ANZ_VERW_JOKER}"></input>
